...
@EnableJpaRepositories(
        ...
        basePackages = {"com.skspruce.ism.detect.webapi.strategy.repository.mysqlsecondary"})
public class SecondaryMysqlConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactorySecondary(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.skspruce.ism.detect.webapi.strategy.mysqlsecondaryentity") //设置实体类所在位置
